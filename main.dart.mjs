...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1679: x0 => x0.remove(),
      _2053: x0 => x0.getBounds(),
      _2054: x0 => x0.getCenter(),
      _2058: x0 => x0.getHeading(),
      _2063: x0 => x0.getProjection(),
      _2066: x0 => x0.getTilt(),
      _2068: x0 => x0.getZoom(),
      _2073: (x0,x1) => x0.setHeading(x1),
      _2076: (x0,x1) => x0.setOptions(x1),
      _2079: (x0,x1) => x0.setTilt(x1),
      _2081: (x0,x1) => x0.setZoom(x1),
      ...
      _2960: x0 => x0.lat(),
      _2961: x0 => x0.lng(),
      _2989: x0 => x0.getNorthEast(),
      _2990: x0 => x0.getSouthWest(),
      _3021: x0 => x0.x,
      _3023: x0 => x0.y,
      ...
      _4069: (x0,x1,x2) => x0.fromLatLngToPoint(x1,x2),
      _4070: (x0,x1) => x0.fromLatLngToPoint(x1),
      _4072: (x0,x1,x2) => x0.fromPointToLatLng(x1,x2),
      _4105: (x0,x1) => { x0.url = x1 },
      _4106: (x0,x1) => { x0.anchor = x1 },
      ...
      _4276: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._4276(f,arguments.length,x0) }),
