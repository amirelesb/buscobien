...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1409: (x0,x1,x2) => ({enableHighAccuracy: x0,timeout: x1,maximumAge: x2}),
      _1410: (x0,x1,x2,x3) => x0.getCurrentPosition(x1,x2,x3),
      _1415: (x0,x1) => x0.getItem(x1),
      _1416: (x0,x1) => x0.removeItem(x1),
      _1418: (x0,x1) => x0.getContext(x1),
      _1419: (x0,x1,x2,x3,x4) => x0.clearRect(x1,x2,x3,x4),
      _1420: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      _1421: x0 => x0.close(),
      _1422: (x0,x1) => x0.querySelector(x1),
      _1423: x0 => ({type: x0}),
      _1424: (x0,x1) => new Blob(x0,x1),
      _1425: (x0,x1) => x0.item(x1),
      _1426: () => new FileReader(),
      _1428: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1429: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1429(f,arguments.length,x0) }),
      _1430: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      _1431: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1431(f,arguments.length,x0) }),
      _1432: (x0,x1,x2) => x0.addEventListener(x1,x2),
      ...
      _1454: x0 => new WeakRef(x0),
      _1455: x0 => x0.deref(),
      _1462: () => globalThis.WeakRef,
      _1466: s => JSON.stringify(s),
      _1467: s => printToConsole(s),
      _1468: (o, p, r) => o.replaceAll(p, () => r),
      _1470: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1471: s => s.toUpperCase(),
      _1472: s => s.trim(),
      _1473: s => s.trimLeft(),
      _1474: s => s.trimRight(),
      _1475: (string, times) => string.repeat(times),
      _1476: Function.prototype.call.bind(String.prototype.indexOf),
      _1477: (s, p, i) => s.lastIndexOf(p, i),
      _1478: (string, token) => string.split(token),
      _1479: Object.is,
      _1480: o => o instanceof Array,
      _1481: (a, i) => a.push(i),
      _1485: a => a.pop(),
      _1486: (a, i) => a.splice(i, 1),
      _1487: (a, s) => a.join(s),
      _1488: (a, s, e) => a.slice(s, e),
      _1490: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1491: a => a.length,
      _1493: (a, i) => a[i],
      _1494: (a, i, v) => a[i] = v,
      _1496: o => {
      ...
      _1497: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1499: o => o instanceof Uint8Array,
      _1500: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1501: o => o instanceof Int8Array,
      _1502: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1503: o => o instanceof Uint8ClampedArray,
      _1504: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1505: o => o instanceof Uint16Array,
      _1506: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1507: o => o instanceof Int16Array,
      _1508: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1509: o => o instanceof Uint32Array,
      _1510: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1511: o => o instanceof Int32Array,
      _1512: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1514: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1515: o => o instanceof Float32Array,
      _1516: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1517: o => o instanceof Float64Array,
      ...
      _1526: (b, o) => new DataView(b, o),
      _1527: (b, o, l) => new DataView(b, o, l),
      _1528: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1529: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1530: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1531: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1532: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1533: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1534: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1535: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1536: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1537: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1538: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1539: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1542: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1543: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1544: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1545: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1546: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1547: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1560: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1561: (handle) => clearTimeout(handle),
      _1562: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1563: (handle) => clearInterval(handle),
      _1564: (c) =>
      ...
      _1567: (x0,x1) => x0.exec(x1),
      _1568: (x0,x1) => x0.test(x1),
      _1569: x0 => x0.pop(),
      _1571: o => o === undefined,
      _1573: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1575: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1576: o => o instanceof RegExp,
      _1577: (l, r) => l === r,
      _1578: o => o,
      _1579: o => o,
      _1580: o => o,
      ...
      _1618: x0 => x0.index,
      _1620: x0 => x0.flags,
      _1621: x0 => x0.multiline,
      _1622: x0 => x0.ignoreCase,
      _1623: x0 => x0.unicode,
      _1624: x0 => x0.dotAll,
      _1625: (x0,x1) => { x0.lastIndex = x1 },
      _1626: (o, p) => p in o,
      _1627: (o, p) => o[p],
      _1663: (x0,x1,x2) => globalThis.google.maps.event.addListener(x0,x1,x2),
      _1664: x0 => x0.remove(),
      _2039: x0 => x0.getCenter(),
      _2043: x0 => x0.getHeading(),
      _2051: x0 => x0.getTilt(),
      _2053: x0 => x0.getZoom(),
      _2061: (x0,x1) => x0.setOptions(x1),
      _2067: f => finalizeWrapper(f, function() { return dartInstance.exports._2067(f,arguments.length) }),
      _2069: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2069(f,arguments.length,x0) }),
      _2076: f => finalizeWrapper(f, function() { return dartInstance.exports._2076(f,arguments.length) }),
      _2085: f => finalizeWrapper(f, function() { return dartInstance.exports._2085(f,arguments.length) }),
      _2088: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2088(f,arguments.length,x0) }),
      _2089: x0 => x0.latLng,
      _2135: x0 => x0.latLng,
      _2142: (x0,x1) => { x0.cameraControl = x1 },
      _2146: (x0,x1) => { x0.center = x1 },
      _2164: (x0,x1) => { x0.fullscreenControl = x1 },
      _2167: (x0,x1) => { x0.gestureHandling = x1 },
      _2180: (x0,x1) => { x0.mapId = x1 },
      _2182: (x0,x1) => { x0.mapTypeControl = x1 },
      _2186: (x0,x1) => { x0.mapTypeId = x1 },
      _2188: (x0,x1) => { x0.maxZoom = x1 },
      _2190: (x0,x1) => { x0.minZoom = x1 },
      _2201: x0 => x0.rotateControl,
      _2202: (x0,x1) => { x0.rotateControl = x1 },
      _2214: (x0,x1) => { x0.streetViewControl = x1 },
      _2217: (x0,x1) => { x0.styles = x1 },
      _2220: (x0,x1) => { x0.tilt = x1 },
      _2224: (x0,x1) => { x0.zoom = x1 },
      _2226: (x0,x1) => { x0.zoomControl = x1 },
      _2234: () => globalThis.google.maps.MapTypeId.HYBRID,
      _2235: () => globalThis.google.maps.MapTypeId.ROADMAP,
      _2236: () => globalThis.google.maps.MapTypeId.SATELLITE,
      _2237: () => globalThis.google.maps.MapTypeId.TERRAIN,
      _2242: (x0,x1) => { x0.stylers = x1 },
      _2244: (x0,x1) => { x0.elementType = x1 },
      _2246: (x0,x1) => { x0.featureType = x1 },
      _2339: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._2339(f,arguments.length,x0,x1,x2) }),
      _2340: (x0,x1,x2) => ({map: x0,markers: x1,onClusterClick: x2}),
      _2351: x0 => new markerClusterer.MarkerClusterer(x0),
      _2945: x0 => x0.lat(),
      _2946: x0 => x0.lng(),
      _3944: (x0,x1) => x0.setContent(x1),
      _3969: x0 => x0.content,
      _3970: (x0,x1) => { x0.content = x1 },
      _3986: (x0,x1) => { x0.zIndex = x1 },
      _4090: (x0,x1) => { x0.url = x1 },
      _4098: (x0,x1) => { x0.scaledSize = x1 },
      _4100: (x0,x1) => { x0.size = x1 },
      _4108: x0 => x0.getMap(),
      _4121: (x0,x1) => x0.setMap(x1),
      _4123: (x0,x1) => x0.setOptions(x1),
      _4124: (x0,x1) => x0.setPosition(x1),
      _4127: (x0,x1) => x0.setVisible(x1),
      _4130: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._4130(f,arguments.length,x0) }),
      _4135: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._4135(f,arguments.length,x0) }),
      _4136: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._4136(f,arguments.length,x0) }),
      _4138: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._4138(f,arguments.length,x0) }),
      _4176: (x0,x1) => { x0.draggable = x1 },
      _4178: (x0,x1) => { x0.icon = x1 },
      _4184: (x0,x1) => { x0.opacity = x1 },
      _4188: (x0,x1) => { x0.position = x1 },
      _4192: (x0,x1) => { x0.title = x1 },
      _4194: (x0,x1) => { x0.visible = x1 },
      _4196: (x0,x1) => { x0.zIndex = x1 },
      _4260: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._4260(f,arguments.length,x0) }),
      _4262: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _4263: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _4271: () => new AbortController(),
      _4272: x0 => x0.abort(),
      _4273: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _4274: (x0,x1) => globalThis.fetch(x0,x1),
      _4275: (x0,x1) => x0.get(x1),
      ...
      _4282: (x0,x1) => x0.key(x1),
      _4283: x0 => x0.trustedTypes,
      _4284: (x0,x1) => { x0.innerHTML = x1 },
      _4285: (x0,x1) => { x0.innerHTML = x1 },
      _4286: x0 => x0.random(),
      _4289: () => globalThis.Math,
      _4293: (x0,x1,x2) => x0.toDataURL(x1,x2),
      _4297: Function.prototype.call.bind(Number.prototype.toString),
      _4298: Function.prototype.call.bind(BigInt.prototype.toString),
      _4299: Function.prototype.call.bind(Number.prototype.toString),
      _4300: (d, digits) => d.toFixed(digits),
      _4402: () => globalThis.document,
      _4408: (x0,x1) => { x0.height = x1 },
      _4410: (x0,x1) => { x0.width = x1 },
      _4419: x0 => x0.style,
      _4422: x0 => x0.src,
      _4423: (x0,x1) => { x0.src = x1 },
      _4424: x0 => x0.naturalWidth,
      _4425: x0 => x0.naturalHeight,
      _4441: x0 => x0.status,
      _4442: (x0,x1) => { x0.responseType = x1 },
      _4444: x0 => x0.response,
      _4561: (x0,x1) => { x0.draggable = x1 },
      _4567: (x0,x1) => { x0.innerText = x1 },
      _4577: x0 => x0.style,
      _4598: (x0,x1) => { x0.onclick = x1 },
      _5506: (x0,x1) => { x0.accept = x1 },
      _5520: x0 => x0.files,
      _5546: (x0,x1) => { x0.multiple = x1 },
      _5564: (x0,x1) => { x0.type = x1 },
      _5860: (x0,x1) => { x0.width = x1 },
      _5862: (x0,x1) => { x0.height = x1 },
      _6282: () => globalThis.window,
      _6345: x0 => x0.navigator,
      _6607: x0 => x0.trustedTypes,
      _6609: x0 => x0.localStorage,
      _6715: x0 => x0.geolocation,
      _6720: x0 => x0.permissions,
      _6740: x0 => x0.onLine,
      _6767: x0 => x0.width,
      _6768: x0 => x0.height,
      _6941: x0 => x0.length,
      _8886: x0 => x0.signal,
      _8947: x0 => x0.firstChild,
      _8958: () => globalThis.document,
      _9377: (x0,x1) => { x0.id = x1 },
      _9379: (x0,x1) => { x0.className = x1 },
      _9404: x0 => x0.children,
      _10723: x0 => x0.value,
      _10725: x0 => x0.done,
      _10905: x0 => x0.size,
      _10906: x0 => x0.type,
      ...
      _11421: x0 => x0.url,
      _11423: x0 => x0.status,
      _11425: x0 => x0.statusText,
      _11426: x0 => x0.headers,
      _11427: x0 => x0.body,
      _11814: x0 => x0.state,
      _13131: x0 => x0.coords,
      _13132: x0 => x0.timestamp,
      _13134: x0 => x0.accuracy,
      _13135: x0 => x0.latitude,
      _13136: x0 => x0.longitude,
      _13137: x0 => x0.altitude,
      _13138: x0 => x0.altitudeAccuracy,
      _13139: x0 => x0.heading,
      _13140: x0 => x0.speed,
      _13141: x0 => x0.code,
      _13142: x0 => x0.message,
      _13828: (x0,x1) => { x0.display = x1 },
      _13992: (x0,x1) => { x0.height = x1 },
      _14682: (x0,x1) => { x0.width = x1 },
      _15050: x0 => x0.name,
      _15792: (x0,x1,x2,x3,x4,x5,x6,x7) => ({hue: x0,lightness: x1,saturation: x2,gamma: x3,invert_lightness: x4,visibility: x5,color: x6,weight: x7}),
