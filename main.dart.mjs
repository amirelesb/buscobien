...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      BK: x0 => x0.image,
      BL: (x0,x1) => { x0.scaledSize = x1 },
      BM: x0 => x0.getHeading(),
      BN: x0 => x0.convertToBlob(),
      ...
      DL: (x0,x1) => new google.maps.Size(x0,x1),
      DM: x0 => x0.latLng,
      DN: x0 => x0.height,
      ...
      EL: (x0,x1) => new google.maps.Point(x0,x1),
      EM: (x0,x1) => new google.maps.Map(x0,x1),
      EN: x0 => x0.width,
      ...
      FL: (x0,x1) => { x0.anchor = x1 },
      FM: (x0,x1) => { x0.tilt = x1 },
      FN: x0 => x0.rasterEndMilliseconds,
      FO: x0 => x0.message,
      ...
      GL: x0 => x0.height,
      GM: x0 => x0.rotateControl,
      GN: x0 => x0.rasterStartMilliseconds,
      GO: x0 => x0.code,
      ...
      HL: x0 => x0.width,
      HM: (x0,x1) => { x0.center = x1 },
      HN: x0 => x0.imageBitmaps,
      HO: x0 => x0.speed,
      ...
      IJ: x0 => x0.read(),
      IK: x0 => x0.subtle,
      IL: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      IM: (x0,x1) => { x0.zoom = x1 },
      IN: (x0,x1) => x0.getContext(x1),
      IO: x0 => x0.heading,
      J: o => o,
      ...
      JL: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.X(f,arguments.length,x0) }),
      JM: () => ({}),
      JN: (x0,x1,x2,x3,x4) => x0.clearRect(x1,x2,x3,x4),
      JO: x0 => x0.accuracy,
      K: o => String(o),
      KB: b => !!b,
      ...
      KL: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      KM: (x0,x1) => { x0.mapId = x1 },
      KN: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      ...
      LL: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.Y(f,arguments.length,x0) }),
      LM: (x0,x1) => { x0.styles = x1 },
      LN: x0 => x0.close(),
      LO: x0 => x0.altitude,
      M: (l, r) => l === r,
      ...
      ML: (x0,x1) => { x0.src = x1 },
      MM: (x0,x1) => { x0.streetViewControl = x1 },
      MN: (x0,x1,x2) => x0.toDataURL(x1,x2),
      MO: x0 => x0.timestamp,
      N: x0 => x0.random(),
      NB: () => ({}),
      ...
      NL: (x0,x1) => { x0.url = x1 },
      NM: (x0,x1) => { x0.fullscreenControl = x1 },
      NN: (x0,x1) => { x0.height = x1 },
      NO: x0 => x0.longitude,
      O: o => o,
      OB: (o, p, v) => o[p] = v,
      ...
      OL: (x0,x1) => { x0.draggable = x1 },
      OM: (x0,x1) => { x0.mapTypeControl = x1 },
      ON: (x0,x1) => { x0.width = x1 },
      OO: x0 => x0.latitude,
      P: o => {
      ...
      PK: x0 => x0.crypto,
      PL: (x0,x1) => { x0.opacity = x1 },
      PM: (x0,x1) => { x0.rotateControl = x1 },
      PN: x0 => x0.height,
      PO: x0 => x0.coords,
      Q: () => globalThis.Math,
      QB: (a, i) => a.push(i),
      ...
      QL: (x0,x1) => { x0.visible = x1 },
      QM: (x0,x1) => { x0.cameraControl = x1 },
      QN: x0 => x0.width,
      ...
      RK: x0 => ({type: x0}),
      RL: (x0,x1) => { x0.zIndex = x1 },
      RM: (x0,x1) => { x0.gestureHandling = x1 },
      RN: (x0,x1) => x0.createImageBitmap(x1),
      RO: x0 => x0.state,
      S: (exn) => {
      ...
      SL: (x0,x1) => { x0.title = x1 },
      SM: (x0,x1) => { x0.zoomControl = x1 },
      SN: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.g(f,arguments.length,x0) }),
      ...
      TL: (x0,x1) => { x0.position = x1 },
      TM: (x0,x1) => { x0.maxZoom = x1 },
      TN: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.h(f,arguments.length,x0) }),
      TO: x0 => x0.id,
      ...
      UL: (x0,x1) => { x0.onclick = x1 },
      UM: (x0,x1) => { x0.minZoom = x1 },
      UN: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.i(f,arguments.length,x0) }),
      ...
      VL: x0 => x0.content,
      VM: (x0,x1) => { x0.mapTypeId = x1 },
      VN: (x0,x1) => x0.removeChild(x1),
      ...
      WM: () => globalThis.google.maps.MapTypeId.ROADMAP,
      WN: x0 => x0.firstChild,
      ...
      XL: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.Z(f,arguments.length,x0) }),
      XM: () => globalThis.google.maps.MapTypeId.HYBRID,
      XN: (x0,x1) => { x0.display = x1 },
      XO: x0 => x0.disabled,
      ...
      YK: x0 => x0.remove(),
      YL: x0 => ({createHTML: x0}),
      YM: () => globalThis.google.maps.MapTypeId.TERRAIN,
      ...
      ZK: x0 => x0.click(),
      ZL: (x0,x1,x2) => x0.createPolicy(x1,x2),
      ZM: () => globalThis.google.maps.MapTypeId.SATELLITE,
      ...
      aL: (x0,x1) => x0.createHTML(x1),
      aM: (x0,x1) => { x0.height = x1 },
      aN: (x0,x1) => { x0.draggable = x1 },
      ...
      cL: (x0,x1) => { x0.zIndex = x1 },
      cM: x0 => x0.style,
      cN: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.j(f,arguments.length,x0) }),
      ...
      dK: x0 => x0.document,
      dL: (x0,x1) => { x0.content = x1 },
      dM: (x0,x1) => x0.setVisible(x1),
      dN: x0 => x0.result,
      dO: x0 => x0.baseURI,
      e: (o0, o1) => [o0, o1],
      ...
      fL: (x0,x1) => { x0.innerHTML = x1 },
      fM: (x0,x1) => x0.setOptions(x1),
      fN: x0 => x0.size,
      ...
      gI: x0 => x0.done,
      gJ: x0 => x0.decode(),
      gK: (x0,x1) => x0.removeAt(x1),
      gL: x0 => x0.trustedTypes,
      gM: (x0,x1) => x0.clearMarkers(x1),
      gN: x0 => x0.name,
      ...
      hK: x0 => x0.overlayMapTypes,
      hL: x0 => x0.trustedTypes,
      hM: x0 => x0.onRemove(),
      hN: x0 => x0.type,
      ...
      jK: x0 => new google.maps.InfoWindow(x0),
      jL: (x0,x1) => { x0.className = x1 },
      jM: (x0,x1) => x0.panTo(x1),
      jN: () => new FileReader(),
      ...
      kJ: x0 => x0.URL,
      kK: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.S(f,arguments.length,x0) }),
      kL: x0 => x0.lng(),
      kM: (x0,x1) => new google.maps.LatLngBounds(x0,x1),
      ...
      lI: x0 => x0.Segmenter,
      lJ: x0 => new Blob(x0),
      lK: x0 => new google.maps.Marker(x0),
      lL: x0 => x0.lat(),
      lM: (x0,x1,x2) => x0.fitBounds(x1,x2),
      lN: x0 => x0.files,
      ...
      mK: (x0,x1,x2) => x0.set(x1,x2),
      mL: (x0,x1,x2) => x0.open(x1,x2),
      mM: (x0,x1,x2) => x0.panBy(x1,x2),
      mN: (x0,x1) => x0.key(x1),
      ...
      nK: x0 => x0.remove(),
      nL: x0 => x0.getMap(),
      nM: (x0,x1,x2) => x0.fromPointToLatLng(x1,x2),
      ...
      oI: a => a.pop(),
      oJ: x0 => x0.name,
      oK: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.T(f,arguments.length,x0) }),
      oL: x0 => x0.close(),
      oM: x0 => x0.y,
      oN: x0 => x0.length,
      p: o => o,
      ...
      pK: (x0,x1,x2) => globalThis.google.maps.event.addListener(x0,x1,x2),
      pL: x0 => x0.onAdd(),
      pM: x0 => x0.x,
      pN: x0 => x0.onLine,
      ...
      qJ: x0 => x0.frameCount,
      qK: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.U(f,arguments.length,x0) }),
      qL: x0 => new markerClusterer.MarkerClusterer(x0),
      qM: (x0,x1,x2) => x0.fromLatLngToPoint(x1,x2),
      qN: x0 => x0.decode(),
      r: f => f.dartFunction,
      rB: o => {
        if (o === null || o === undefined) return 0;
      ...
      rK: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.V(f,arguments.length,x0) }),
      rL: () => new Array(),
      rM: (x0,x1) => x0.fromLatLngToPoint(x1),
      ...
      sJ: x0 => x0.completed,
      sK: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.W(f,arguments.length,x0) }),
      sL: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports.a(f,arguments.length,x0,x1,x2) }),
      sM: x0 => x0.getSouthWest(),
      ...
      tJ: x0 => x0.ready,
      tK: (x0,x1) => new google.maps.LatLng(x0,x1),
      tL: (x0,x1,x2) => ({map: x0,markers: x1,onClusterClick: x2}),
      tM: x0 => x0.getNorthEast(),
      ...
      uI: x0 => x0.deref(),
      uJ: x0 => x0.tracks,
      uK: (x0,x1) => x0.setPosition(x1),
      uL: (module,f) => finalizeWrapper(f, function() { return module.exports.b(f,arguments.length) }),
      uM: x0 => x0.getProjection(),
      ...
      vJ: x0 => x0.close(),
      vK: x0 => x0.latLng,
      vL: (module,f) => finalizeWrapper(f, function() { return module.exports.c(f,arguments.length) }),
      vM: x0 => x0.getBounds(),
      vN: x0 => x0.send(),
      ...
      wK: (x0,x1) => x0.setMap(x1),
      wL: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.d(f,arguments.length,x0) }),
      wM: (x0,x1) => x0.setTilt(x1),
      wN: x0 => x0.status,
      ...
      xK: () => ({}),
      xL: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.e(f,arguments.length,x0) }),
      xM: (x0,x1) => x0.setZoom(x1),
      xN: x0 => x0.response,
      ...
      yK: (x0,x1) => { x0.icon = x1 },
      yL: (module,f) => finalizeWrapper(f, function() { return module.exports.f(f,arguments.length) }),
      yM: (x0,x1) => x0.setHeading(x1),
