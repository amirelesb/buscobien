...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AK: x0 => x0.duration,
      AL: () => ({}),
      AM: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.e(f,arguments.length,x0) }),
      AN: (x0,x1) => x0.setZoom(x1),
      ...
      BK: x0 => x0.image,
      BL: (x0,x1) => { x0.icon = x1 },
      BM: (module,f) => finalizeWrapper(f, function() { return module.exports.f(f,arguments.length) }),
      BN: (x0,x1) => x0.setHeading(x1),
      ...
      CL: () => ({}),
      CM: x0 => x0.getZoom(),
      CN: (x0,x1) => x0.transferFromImageBitmap(x1),
      ...
      EL: (x0,x1) => { x0.scaledSize = x1 },
      EM: x0 => x0.getHeading(),
      EN: x0 => x0.convertToBlob(),
      ...
      GL: (x0,x1) => new google.maps.Size(x0,x1),
      GM: x0 => x0.latLng,
      GN: x0 => x0.height,
      GO: x0 => x0.code,
      ...
      HL: (x0,x1) => new google.maps.Point(x0,x1),
      HM: (x0,x1) => new google.maps.Map(x0,x1),
      HN: x0 => x0.width,
      HO: x0 => x0.speed,
      ...
      IJ: x0 => x0.read(),
      IK: x0 => x0.subtle,
      IL: (x0,x1) => { x0.anchor = x1 },
      IM: (x0,x1) => { x0.tilt = x1 },
      IN: x0 => x0.rasterEndMilliseconds,
      IO: x0 => x0.heading,
      J: o => o,
      ...
      JL: x0 => x0.height,
      JM: x0 => x0.rotateControl,
      JN: x0 => x0.rasterStartMilliseconds,
      JO: x0 => x0.accuracy,
      K: o => String(o),
      KB: b => !!b,
      ...
      KL: x0 => x0.width,
      KM: (x0,x1) => { x0.center = x1 },
      KN: x0 => x0.imageBitmaps,
      ...
      LL: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      LM: (x0,x1) => { x0.zoom = x1 },
      LN: (x0,x1) => x0.getContext(x1),
      LO: x0 => x0.altitude,
      M: (l, r) => l === r,
      ...
      ML: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.X(f,arguments.length,x0) }),
      MM: () => ({}),
      MN: (x0,x1,x2,x3,x4) => x0.clearRect(x1,x2,x3,x4),
      MO: x0 => x0.timestamp,
      N: x0 => x0.random(),
      NB: () => ({}),
      ...
      NL: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      NM: (x0,x1) => { x0.mapId = x1 },
      NN: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      NO: x0 => x0.longitude,
      O: o => o,
      OB: (o, p, v) => o[p] = v,
      ...
      OL: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.Y(f,arguments.length,x0) }),
      OM: (x0,x1) => { x0.styles = x1 },
      ON: x0 => x0.close(),
      OO: x0 => x0.latitude,
      P: o => {
      ...
      PK: x0 => x0.crypto,
      PL: (x0,x1) => { x0.src = x1 },
      PM: (x0,x1) => { x0.streetViewControl = x1 },
      PN: (x0,x1,x2) => x0.toDataURL(x1,x2),
      PO: x0 => x0.coords,
      Q: () => globalThis.Math,
      QB: (a, i) => a.push(i),
      QC: x0 => x0.length,
      ...
      QL: (x0,x1) => { x0.url = x1 },
      QM: (x0,x1) => { x0.fullscreenControl = x1 },
      QN: (x0,x1) => { x0.height = x1 },
      ...
      RK: (x0,x1) => x0.key(x1),
      RL: (x0,x1) => { x0.draggable = x1 },
      RM: (x0,x1) => { x0.mapTypeControl = x1 },
      RN: (x0,x1) => { x0.width = x1 },
      RO: x0 => x0.state,
      S: (exn) => {
      ...
      SL: (x0,x1) => { x0.opacity = x1 },
      SM: (x0,x1) => { x0.rotateControl = x1 },
      SN: x0 => x0.height,
      SO: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      T: (c) =>
      ...
      TK: x0 => x0.length,
      TL: (x0,x1) => { x0.visible = x1 },
      TM: (x0,x1) => { x0.cameraControl = x1 },
      TN: x0 => x0.width,
      TO: (x0,x1,x2) => x0.insertBefore(x1,x2),
      ...
      UK: x0 => ({type: x0}),
      UL: (x0,x1) => { x0.zIndex = x1 },
      UM: (x0,x1) => { x0.gestureHandling = x1 },
      UN: (x0,x1) => x0.createImageBitmap(x1),
      UO: x0 => x0.id,
      ...
      VK: (x0,x1) => new Blob(x0,x1),
      VL: (x0,x1) => { x0.title = x1 },
      VM: (x0,x1) => { x0.zoomControl = x1 },
      VN: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.g(f,arguments.length,x0) }),
      VO: x0 => x0.offsetHeight,
      ...
      WK: x0 => globalThis.URL.createObjectURL(x0),
      WL: (x0,x1) => { x0.position = x1 },
      WM: (x0,x1) => { x0.maxZoom = x1 },
      WN: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.h(f,arguments.length,x0) }),
      WO: x0 => x0.offsetWidth,
      ...
      XI: x0 => x0.next(),
      XJ: x0 => x0.style,
      XK: (x0,x1) => x0.getElementById(x1),
      XL: (x0,x1) => { x0.onclick = x1 },
      XM: (x0,x1) => { x0.minZoom = x1 },
      XN: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.i(f,arguments.length,x0) }),
      XO: (x0,x1) => { x0.disabled = x1 },
      ...
      YI: x0 => x0.current(),
      YJ: (x0,x1) => { x0.src = x1 },
      YK: (x0,x1,x2) => x0.setAttribute(x1,x2),
      YL: x0 => x0.content,
      YM: (x0,x1) => { x0.mapTypeId = x1 },
      ...
      ZK: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.R(f,arguments.length,x0) }),
      ZL: (x0,x1) => x0.appendChild(x1),
      ZM: () => globalThis.google.maps.MapTypeId.ROADMAP,
      ZN: x0 => x0.firstChild,
      ZO: (x0,x1) => { x0.min = x1 },
      ...
      aJ: x0 => x0.src,
      aK: (x0,x1,x2) => x0.addEventListener(x1,x2),
      aL: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.Z(f,arguments.length,x0) }),
      aM: () => globalThis.google.maps.MapTypeId.HYBRID,
      aN: (x0,x1) => { x0.display = x1 },
      aO: (x0,x1) => { x0.max = x1 },
      b: (constructor, args) => {
      ...
      bK: x0 => x0.remove(),
      bL: x0 => ({createHTML: x0}),
      bM: () => globalThis.google.maps.MapTypeId.TERRAIN,
      bN: (x0,x1) => { x0.accept = x1 },
      bO: (x0,x1) => { x0.scrollLeft = x1 },
      c: x0 => new Array(x0),
      ...
      cJ: (x0,x1) => { x0.src = x1 },
      cK: x0 => x0.click(),
      cL: (x0,x1,x2) => x0.createPolicy(x1,x2),
      cM: () => globalThis.google.maps.MapTypeId.SATELLITE,
      cN: (x0,x1) => { x0.multiple = x1 },
      cO: (x0,x1) => { x0.spellcheck = x1 },
      d: o => [o],
      ...
      dK: (x0,x1) => { x0.target = x1 },
      dL: (x0,x1) => x0.createHTML(x1),
      dM: (x0,x1) => { x0.height = x1 },
      dN: (x0,x1) => { x0.draggable = x1 },
      dO: (x0,x1) => { x0.disabled = x1 },
      e: (o0, o1) => [o0, o1],
      ...
      fL: (x0,x1) => { x0.zIndex = x1 },
      fM: x0 => x0.style,
      fN: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.j(f,arguments.length,x0) }),
      fO: (x0,x1) => x0.getContext(x1),
      ...
      gJ: x0 => x0.decode(),
      gK: x0 => x0.document,
      gL: (x0,x1) => { x0.content = x1 },
      gM: (x0,x1) => x0.setVisible(x1),
      gN: x0 => x0.result,
      ...
      hL: (x0,x1) => { x0.innerHTML = x1 },
      hM: (x0,x1) => x0.setContent(x1),
      hN: x0 => x0.length,
      ...
      iK: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      iL: (x0,x1) => { x0.innerHTML = x1 },
      iM: (x0,x1) => x0.setOptions(x1),
      iN: x0 => x0.size,
      ...
      jK: (x0,x1) => x0.removeAt(x1),
      jL: x0 => x0.trustedTypes,
      jM: (x0,x1) => x0.clearMarkers(x1),
      jN: x0 => x0.name,
      ...
      kJ: x0 => x0.URL,
      kK: x0 => x0.overlayMapTypes,
      kL: x0 => x0.trustedTypes,
      kM: x0 => x0.onRemove(),
      kN: x0 => x0.type,
      ...
      lJ: x0 => new Blob(x0),
      lK: () => ({}),
      lL: (x0,x1) => { x0.innerText = x1 },
      lM: (x0,x1) => x0.setOptions(x1),
      lN: (x0,x1) => x0.item(x1),
      ...
      mK: x0 => new google.maps.InfoWindow(x0),
      mL: (x0,x1) => { x0.className = x1 },
      mM: (x0,x1) => x0.panTo(x1),
      mN: () => new FileReader(),
      ...
      nK: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.S(f,arguments.length,x0) }),
      nL: x0 => x0.lng(),
      nM: (x0,x1) => new google.maps.LatLngBounds(x0,x1),
      nN: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      oI: a => a.pop(),
      oJ: x0 => x0.name,
      oK: x0 => new google.maps.Marker(x0),
      oL: x0 => x0.lat(),
      oM: (x0,x1,x2) => x0.fitBounds(x1,x2),
      oN: x0 => x0.files,
      p: o => o,
      ...
      pK: (x0,x1,x2) => x0.set(x1,x2),
      pL: (x0,x1,x2) => x0.open(x1,x2),
      pM: (x0,x1,x2) => x0.panBy(x1,x2),
      pN: x0 => x0.onLine,
      ...
      qK: x0 => x0.remove(),
      qL: x0 => x0.getMap(),
      qM: (x0,x1,x2) => x0.fromPointToLatLng(x1,x2),
      qN: x0 => x0.decode(),
      r: f => f.dartFunction,
      rB: o => {
        if (o === null || o === undefined) return 0;
      ...
      rK: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.T(f,arguments.length,x0) }),
      rL: x0 => x0.close(),
      rM: x0 => x0.y,
      ...
      sJ: x0 => x0.completed,
      sK: (x0,x1,x2) => globalThis.google.maps.event.addListener(x0,x1,x2),
      sL: x0 => x0.onAdd(),
      sM: x0 => x0.x,
      ...
      tJ: x0 => x0.ready,
      tK: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.U(f,arguments.length,x0) }),
      tL: x0 => new markerClusterer.MarkerClusterer(x0),
      tM: (x0,x1,x2) => x0.fromLatLngToPoint(x1,x2),
      ...
      uI: x0 => x0.deref(),
      uJ: x0 => x0.tracks,
      uK: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.V(f,arguments.length,x0) }),
      uL: () => new Array(),
      uM: (x0,x1) => x0.fromLatLngToPoint(x1),
      ...
      vJ: x0 => x0.close(),
      vK: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.W(f,arguments.length,x0) }),
      vL: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports.a(f,arguments.length,x0,x1,x2) }),
      vM: x0 => x0.getSouthWest(),
      vN: x0 => x0.send(),
      ...
      wK: (x0,x1) => new google.maps.LatLng(x0,x1),
      wL: (x0,x1,x2) => ({map: x0,markers: x1,onClusterClick: x2}),
      wM: x0 => x0.getNorthEast(),
      wN: x0 => x0.status,
      ...
      xK: (x0,x1) => x0.setPosition(x1),
      xL: (module,f) => finalizeWrapper(f, function() { return module.exports.b(f,arguments.length) }),
      xM: x0 => x0.getProjection(),
      xN: x0 => x0.response,
      ...
      yK: x0 => x0.latLng,
      yL: (module,f) => finalizeWrapper(f, function() { return module.exports.c(f,arguments.length) }),
      yM: x0 => x0.getBounds(),
      ...
      zK: (x0,x1) => x0.setMap(x1),
      zL: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.d(f,arguments.length,x0) }),
      zM: (x0,x1) => x0.setTilt(x1),
